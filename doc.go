// Package snapshot provides aggregate state snapshotting for event-sourced systems.
//
// This package enables periodic state persistence of aggregate roots to optimize load times.
// By loading the latest snapshot and replaying only subsequent events instead of replaying
// the entire stream from version 1, read performance remains fast even for aggregates with
// long histories.
//
// Key features:
//
