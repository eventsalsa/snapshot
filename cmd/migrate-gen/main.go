...
// Usage:
//
//	go run github.com/eventsalsa/snapshot/cmd/migrate-gen -output migrations -filename init.sql
//
// Or with go generate:
//
//	//go:generate go run github.com/eventsalsa/snapshot/cmd/migrate-gen -output migrations
package main
